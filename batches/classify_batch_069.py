...
def main():
    # 读取输入文件
    with open("/Users/zhijian/workspace/mind-mining/v1.0/batches/batch_069.json", "r", encoding="utf-8") as f:
        posts = json.load(f)
    ...
    # 输出结果
    with open("/Users/zhijian/workspace/batches/result_batch_069.json", "w", encoding="utf-8") as f:
